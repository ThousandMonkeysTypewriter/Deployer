...
public class TensorFlowImportTest {
	...
	public static void main(String[] args) throws Exception {
		TensorFlowImportTest tfi = new TensorFlowImportTest();
		tfi.importGraph1();
	}
    ...
    public void importGraph1() throws Exception {
		File initialFile = new File("/root/NeuralProgramSynthesis/log/graph.pb");
        InputStream targetStream = new FileInputStream(initialFile);
        SameDiff graph = TFGraphMapper.getInstance().importGraph(targetStream);
